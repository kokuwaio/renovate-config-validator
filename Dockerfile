...
RUN --mount=type=cache,target=/tmp PATH="$PATH:/opt/node/bin" npm install "renovate@43.150.0" --global --no-fund --cache=/tmp && \
...
FROM docker.io/library/debian:13.5-slim@sha256:dd723c6aa29afd6e310a82dca36ecd596ccc34827d6e3518ab41873b7b582f07 AS renovate-config-validator
